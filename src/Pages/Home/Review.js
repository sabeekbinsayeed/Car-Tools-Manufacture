...
const Review = ({ review }) => {
    ...
    return (
        <div>
            ...
            <div class="mb-12 md:mb-0 border-2">
                <div class="flex justify-center mb-6">
                    <img src={review.img} class="rounded-full shadow-lg w-32" />
                </div>
                <h5 class="text-lg font-bold mb-4">{review.name}</h5>
                <h6 class="font-medium text-blue-600 mb-4">{review.profession}</h6>
                <p class="mb-4">
